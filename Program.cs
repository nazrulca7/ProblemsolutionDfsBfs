    ...
    class CustomLinklist //--Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            for (int qItr = 0; qItr < q; qItr++)
            {
                ...
                List<int> result = Result.bfs(0, graph,ref visited,ref dist);
                    int MAX = -1;
                    int farthestNode = 0;
                ...
                List<int> result1 = Result.bfs(farthestNode, graph, ref visited, ref dist);
                int FMAX = 0;
                int farthestNode2 = 0;
                ...
                List<int> distFromF2Result = Result.bfs(farthestNode2, graph, ref visited, ref distF2);
